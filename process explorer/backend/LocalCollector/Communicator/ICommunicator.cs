...
namespace ProcessExplorer.LocalCollector.Communicator
{
    public interface ICommunicator
    {
        ...
        /// <returns></returns>
        Task UpdateConnectionInformation(string assemblyId, ConnectionInfo connection);
        ...
        /// <returns></returns>
        Task UpdateEnvironmentVariableInformation(string assemblyId, EnvironmentMonitorInfo environmentVariables);
        ...
        /// <returns></returns>
        Task UpdateRegistrationInformation(string assemblyId, RegistrationMonitorInfo registrations);
        ...
        /// <returns></returns>
        Task UpdateModuleInformation(string assemblyId, ModuleMonitorInfo modules);
    }
}
