...
class SuperRPC {
    ...
    deserializeFunctionArgs(func, args, replyChannel) {
        return args.map((arg, idx) => this.processAfterSerialization(arg, replyChannel, (0, rpc_descriptor_types_1.getArgumentDescriptor)(func, idx)));
    }
    ...
    getProxyObject(objId) {
        ...
        if ((0, rpc_descriptor_types_1.isFunctionDescriptor)(descriptor)) {
    ...
    processAfterSerialization(obj, replyChannel, descriptor) {
        ...
        for (const key of Object.keys(obj)) {
            obj[key] = this.processAfterSerialization(obj[key], replyChannel, (0, rpc_descriptor_types_1.getPropertyDescriptor)(descriptor, key));
        }
        return obj;
    }
