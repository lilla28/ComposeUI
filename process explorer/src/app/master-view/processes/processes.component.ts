...
export class ProcessesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.subscription = interval(1000).subscribe( (val:any) => this.mockProcessesService.getProcs().subscribe(
      (data:ProcessInfo[]) => this.mockProcessesData = data, 
      _ => console.log("Error"),
      () => console.log("MOCKPROCESSES:", this.mockProcessesData)));
  }
}
