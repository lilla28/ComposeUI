...
public class UserChannelTests : ChannelTestFixture
{
    private const string TestChannel = "testChannel";
    private readonly UserChannel _channel = new UserChannel(TestChannel, new Mock<IMessagingService>().Object, null);
